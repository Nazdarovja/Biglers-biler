 ...
 * GET
 * ..api/cars (returns all cars also rented) 
 * ../api/cars/xxxx (returns a specific cars with regno=xxxx) 
 * ../api/cars?location=xxxx (returns only cars from specific location) 
 * ../api/cars?category=xxxx (returns only cars vacant within that category) 
 * ../api/cars?start=xxxx&end=xxxx (returns only cars vacant in this period) 
 * ../api/cars?location=xxxx&start=xxxx&end=xxxx (returns only cars vacant from specific location)
 * ../api/cars?category=xxxx&start=xxxx&end=xxxx (returns only cars vacant within that category)
 * ../api/cars?location=xxxx&category=xxxx&start=xxxx&end=xxxx (returns only cars vacant within that category on a specific location) 
 * PUT: 
 * ../api/cars/xxxx + car json object (hvor xxxx = regno) (changes a specific car in the json object to be rented in this period) 
 * 
 */
...
public class CarService {
	...
	/**
	 * URL: /api/cars/xxxx
	 * This API Is used to create the CARs along with the reservations.
	 * If the CAR is already there and ONLY the reservations are added.
	 * 
	 * @return 
	 */
	@PUT
	 ...
	 * 
	 * This method helps in validating the reservation. We would proceed ahead with reservation 
	 * only if it is valid.
	 * 
	 * @param reservation
	 * @return
	 ...
	 * 
	 * This method is used to get the CAR with the given regno
	 * This would also fetch all the reservations corresponding to that car.
	 *  
	 *
	 * @param regno
	 * @return cars object. Blank object if the are with the given regno is not found.
	 */
	@GET
	@Path("{regno}")
	@Produces(MediaType.APPLICATION_JSON)
	...
	/**
	 * Is Car already existing ? Since are are using a PUT object of car to PUT new reservation, it is important
	 * to check. 
	 * 
	 ...
	 * 
	 * IF the CAR exists
	 * THEN we ONLY add the reservations.
	 * 
	 * @param em
	 * @param regno
	 * 
	...
	/**
	 * This method checks if the Reservation is already existing. It Verified for the overlapping dates for the 
	 * regno with fromDate and toDate.
	 * 
	 * @param em
	 * @param car
	 * @param newStartDate
